...
class RMLtoSHACL:
    ...
    def writeShapeToFile(self, outputfileName):
        ...
        self.SHACL.graph.serialize(destination=outputfileName, format='turtle')


    def evaluate_file(self, rml_mapping_file, outputfileName):
