...
class dataLoader():
    ...
    def _get_rules_values(self, sheet_name, start_cell1, start_cell2, start_cell3, start_cell4):
        ...
        print("col1", start_cell1, start_row1, col1[0:3], type(col1))
        col2, start_row2 = self._split_cell(start_cell2)
        print("col2", start_cell2, start_row2, col2[0:3], type(col2))
        col3, start_row3 = self._split_cell(start_cell3)
        print("col3", start_cell3, start_row3, col3[0:3], type(col3))
        col4, start_row4 = self._split_cell(start_cell4)
        print(start_cell4)
        print("col4", start_cell4, start_row4, col4[0:3], type(col4))
    ...
    def _get_rules_values_with_location(self, sheet_name, class_cell, prop_cell, xpath_cell):
        sheet = self.workbook[sheet_name]
        col1, start_row1 = self._split_cell(class_cell)
        col2, start_row2 = self._split_cell(prop_cell)
        col3, start_row3 = self._split_cell(xpath_cell)

        if None in (col1, start_row1, col2, start_row2, col3, start_row3):
            raise ValueError("Invalid configuration for cell references.")
        ...
        for row in range(max(start_row1, start_row2, start_row3), max_row + 1):
            ...
            if cell_value1 is not None and cell_value2 is not None:
                ...
                l2.append(cell_value2)
                l3.append(cell_value3)
                l4.append(f"{col1}{row}/{col2}{row}")  # new field_id = "I3/J3" style
    ...
    def load_rules(self, sheet_name):
        ...
        class_paths, property_paths, field_XPaths, field_ids = self._get_rules_values_with_location(
            sheet_name,
            class_path_cell,
            property_path_cell,
            field_XPath_cell
